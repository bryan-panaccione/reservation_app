                        ...
                        <div className="wpo-blog-content clearfix">
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <ul>
                                        ...
                                        <li><Link onClick={ClickHandler} to="/blog-details">SEO</Link></li>
                                    </ul>
                                </div>
                                <div className="share">
                                    <ul>
                                        ...
                                        <li><Link onClick={ClickHandler} to="/blog-details"><i className="ti-linkedin"></i></Link></li>
                            ...
                            <div className="author-box">
                                ...
                                <div className="author-content">
                                    <Link onClick={ClickHandler} to="/blog-details" className="author-name">Robert Bartler</Link>
